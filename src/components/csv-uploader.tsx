       ...
       const totalChunks = Math.ceil(allData.length / CHUNK_SIZE);
        ...
        for (let i = 0; i < totalChunks; i++) {
            ...
            for (const record of recordsToProcess) {
              ...
              // Explicitly delete the 'id' field from the record before an insert operation.
              // This is a safeguard to prevent 'id cannot be null' errors for tables where 'id'
              // is an auto-incrementing primary key that should be generated by the database.
              if (!isUpdate) {
                delete record.id;
              }
