...
const COLUMN_ALIASES: Record<string, Record<string, string>> = {
    inventario_master: {
        ...
        'tiempo_produccion': 'esti_time',
        'PRESENTACION MASTER 1': 'empaquetado_master',
        'PIEZAS POR MASTER': 'pz_empaquetado_master',
        'CODIGO EN SIGGO': 'cod_siggo',
        'NOMBRE EN SIGGO': 'nombre_siggo',
        'STOCK EN SIGGO AL MARTES 10 FEBRERO 7:30 AM APROX': 'stock_maestro',
        'MINIMO DE STOCK': 'min_stock',
        'MAXIMO DE STOCK': 'max_stock',
