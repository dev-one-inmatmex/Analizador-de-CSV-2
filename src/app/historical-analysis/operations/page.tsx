...
import { ArrowLeft, ShoppingCart, Truck, DollarSign, Timer, Filter, LogOut, Loader2, BarChart3, AlertTriangle } from 'lucide-react';
...
const costByMonthData = [
  { month: 'Ene', cost: 35000 }, { month: 'Feb', cost: 42000 }, { month: 'Mar', cost: 38000 },
  { month: 'Abr', cost: 55000 }, { month: 'May', cost: 62000 }, { month: 'Jun', cost: 53450.75 },
];
...
export default function AcquisitionsAnalysisPage() {
  ...
  const handleApplyFilters = () => {
    toast({
      ...
      description: 'Los datos de adquisiciones han sido actualizados (simulación).',
    });
  };
  ...
  const handleClearFilters = () => {
    toast({
      ...
      description: 'Mostrando todos los datos de demostración.',
    });
    setSupplier('Todos');
    setStatus('Todos');
    setDate({ from: subDays(new Date(), 90), to: new Date() });
