    ...
    <>
      ...
      <main className="flex flex-1 flex-col items-center justify-center p-4 md:p-10">
        <Alert className="max-w-xl">
            ...
            <AlertDescription>
                El contenido de &quot;Análisis de Publicaciones&quot; ahora se encuentra dentro de la sección de <Link href="/historical-analysis/sales" className="font-bold underline">Análisis de Ventas</Link>, en la pestaña de &quot;Publicaciones&quot;.
            </AlertDescription>
        </Alert>
      </main>
    </>
