...
export default function MajorMinorSalesClientPage({ initialRecentTransactions }: { initialRecentTransactions: Transaction[] }) {
  ...
  const [displayedTransactions, setDisplayedTransactions] = React.useState(initialRecentTransactions);
  ...
  const handleApplyFilters = () => {
    ...
    // NOTE: Filter logic is using mock data shuffling for demo.
    // A real implementation would re-fetch data or filter `initialRecentTransactions`
